    ...
    def test_basic_sample_with_all_transformers(self) -> None:
        ...
        assert_new_columns_in_frame(
            ...
            expected_new_columns={
                ...
                'DATE_FEATURE_total_seconds_diff_DATE_FEATURE': [0, 0, 0, 0, 0, 0],
                'DATE_FEATURE_total_hours_diff_DATE_FEATURE': [0, 0, 0, 0, 0, 0],
                'DATE_FEATURE_total_days_diff_DATE_FEATURE': [0, 0, 0, 0, 0, 0],
                'NUMERIC_FEATURE_pow_2': [0, 1, 4, 9, 16, 25],
                ...
                'count_in_the_last_2d1h_over_GROUPING_FEATURE_NUM': [1, 1, 1, 2, 2, 2],
